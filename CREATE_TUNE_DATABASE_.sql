...
--
-- Host: localhost
-- Generation Time: Apr 30, 2017 at 09:31 PM
...
--
ALTER TABLE `LINKS`
  MODIFY `LINKS_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `SOURCES`
  MODIFY `SOURCES_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
--
-- AUTO_INCREMENT for table `VERSIONS`
--
ALTER TABLE `VERSIONS`
  MODIFY `VERSION_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
